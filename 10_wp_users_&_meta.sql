...
IF OBJECT_ID('[SimorghPortalZero972].[dbo].[wp_users]', 'U') IS NULL
BEGIN
    CREATE TABLE [SimorghPortalZero972].[dbo].[wp_users] (
        ID INT PRIMARY KEY IDENTITY(2,1),  -- Start the ID at 2 and auto-increment by 1
...
IF OBJECT_ID('[SimorghPortalZero972].[dbo].[wp_users_meta]', 'U') IS NULL
BEGIN
    CREATE TABLE [SimorghPortalZero972].[dbo].[wp_users_meta] (
...
IF OBJECT_ID('[SimorghPortalZero972].[dbo].[wp_wpforo_profiles]', 'U') IS NULL
BEGIN
	CREATE TABLE [SimorghPortalZero972].[dbo].[wp_wpforo_profiles] (
		userid INT NULL,
...
BEGIN
    ...
    INSERT INTO [SimorghPortalZero972].[dbo].[wp_users] (
    ...
    INSERT INTO [SimorghPortalZero972].[dbo].[wp_users_meta] (old_UserID, new_ID)
    VALUES (@OldUserID, @NewID);

    -- Insert into wp_wpforo_profiles using the same new ID
    INSERT INTO [SimorghPortalZero972].[dbo].[wp_wpforo_profiles] (
